...
function initAdmin(socket) {
  ...
  function generateMarkup(orders) {
    return orders.map(function (order) {
      //this map function gives an array 
  ...
  socket.on('orderPlaced', function (order) {
    new noty__WEBPACK_IMPORTED_MODULE_2___default.a({
      ...
      text: 'New order!',
      progressBar: false
    }).show(); //add new items to starting of our order array

    orders.unshift(order); //after that clear whole table

    orderTableBody.innerHTML = ''; //pass new order array 
...
var addToCart = document.querySelectorAll('.add-to-cart'); //here addToCart variable is of type array that so we can loop here
//here we get value to show how many items are in cart on nav bar image of cart

var cartCounter = document.querySelector('#cartCounter'); //make a function updatecart
...
function updateStatus(order) {
  //here we receive those order which we get from single order page
  statuses.forEach(function (status) {
    //whenever status get updated previous all removed and new setup apply
    status.classList.remove('step-completed');
    status.classList.remove('current');
  });
  var stepCompleted = true; //here we run a loop on every status and get their status from single oreder.ejs and update according to them
...
updateStatus(order); //socket client site work here
...
socket.on('orderUpdated', function (data) {
  var updatedOrder = _objectSpread({}, order); //copying order into updatedoreder
...
__webpack_require__(/*! C:\Users\ankur singh\realtime app\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\Users\ankur singh\realtime app\resources\scss\app.scss */"./resources/scss/app.scss");
